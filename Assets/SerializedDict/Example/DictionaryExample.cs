...
namespace AndyL.Serialization.Examples
{
    ...
    public class DictionaryExample : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            dictionaryStringStringList = new() { { "stringkey", new SerializedList<string>() { list = new() { "value1", "value2" } } }, {"stringkey2", new SerializedList<string>() { list = new() { "value1", "value2", "value3" } } } };
            dictionaryIntString = new() { { 10, "stringValue" }, { -1, "value2" }, { 0, "value3" } };
            dictionaryStringIntList = new() { {"stringkey", new SerializedList<int>() { list= new() { 0, 1, 9, 5 } } } };
